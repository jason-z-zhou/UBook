...
<html xmlns="http://www.w3.org/1999/xhtml" onload="check_pageNum()">
	...
	function previousPage() {
		window.self.location = "${pageContext.request.contextPath}/servlet/SearchBookServlet?pageNo=${pageModel.previousPageNo}&searchText=${searchText }&searchMethod=${searchMethod }";
	}	
	
	function nextPage() {
		window.self.location = "${pageContext.request.contextPath}/servlet/SearchBookServlet?pageNo=${pageModel.nextPageNo}&searchText=${searchText }&searchMethod=${searchMethod }";
	}
	
	function bottomPage() {
		window.self.location = "${pageContext.request.contextPath}/servlet/SearchBookServlet?pageNo=${pageModel.bottomPageNo}&searchText=${searchText }&searchMethod=${searchMethod }";
	}
			...
			<div id="templatemo_header">
				...
				<div id="templatemo_social">
					...
					<form action="#" method="post">
						<input type="text" name="searchText" value="${searchText }" id="searchText" class="field" />
