			...
			<div id="templatemo_content_area">
				...
				<div id="templatemo_right">
					<div class="templatemo_section_3">
						...
						<div class="templatemo_section_3">
							<c:choose>
								<c:when test="${empty categoryList1 }"></c:when>
								<c:otherwise>
                                    <table>
										<tr>
											<c:forEach items="${categoryList1 }" var="book">
					...
					<div class="templatemo_section_4">
						...
						<div class="templatemo_section_3">
							<c:choose>
								<c:when test="${empty categoryList2 }"></c:when>
								<c:otherwise>
                                    <table>
										<tr>
											<c:forEach items="${categoryList2 }" var="book">
												<td align="center" valign="middle">
													<img src="book_images/${book.pictureName }" alt="image" />
                                                </td>
                                            </c:forEach>
					...
					<div class="templatemo_section_5">
						...
						<div class="templatemo_section_3">
							<c:choose>
								<c:when test="${empty categoryList3 }"></c:when>
								<c:otherwise>
									<table>
										<tr>
											<c:forEach items="${categoryList3 }" var="book">
												<td align="center" valign="middle">
													<img src="book_images/${book.pictureName }" alt="image" />
                                                </td>
                                            </c:forEach>
