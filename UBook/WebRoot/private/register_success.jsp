...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div class="sample_popup" id="popup"
			...
			<div class="menu_form_body">
				<form method="post" action="servlet/LoginServlet">
					...
					<br>
						<br>
							密 码: <input type="password" name="password" onfocus="select();" />
							<br>
								<br>
		...
		<div id="templatemo_container">
			...
			<div id="templatemo_content_area">
				...
				<div id="templatemo_right">
					...
					<br>
					<p>
						您的用户名为${user.userName }，固定邮箱为${user.email }，固定地址为${user.address }。
					</p>
					<br>
					<p>
						是否需要
						<a href="private/user_modify.jsp">更改注册信息</a>?
					</p>
		...
		<!-- End Of Container -->
		<div class="cleaner"></div><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>
